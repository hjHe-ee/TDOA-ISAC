...
maxIter = 50; tol = 1e-6; lambda0 = 1e-2; lambdaGrow = 10; lambdaShrink = 0.3; lambdaMax = 1e9;
wFloor = 0.05; stepClip = 5.0;
...
showVectors = true; vecMaxShow = 400;
heatBins = [12, 8];
...
if plotGeometry
    ...
    if showVectors
        ...
        quiver(UE_true(idxv,1), UE_true(idxv,2), ...
               UE_est(idxv,1)-UE_true(idxv,1), UE_est(idxv,2)-UE_true(idxv,2), ...
